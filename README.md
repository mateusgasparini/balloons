...
<h2 id='my_holidays'>MY HOLIDAYS</h2>
...
<p align='justify'> To use this aplication, just follow the guide below: </p>

```bash
# Download this repository and put it's files in your server folder (i used Xampp)

# Create a database and edit the connection.php file inside the backend folder, put your informations at the following order:

("server", "user", "password", "database")

```
<img src='assets/previews/connection.jpg' style='width:100%'>

```bash

# After the server is set and the $connection variable is changed, open the phpMyAdmin and import the balloons.sql file inside the project folder

# The balloons.sql will import the database strucuture, and the site should work perfectly

```

<h2 id='tecnologies'>TECNOLOGIES</h2>

<p align='justify'> The following tecnologies where used in this website construciton </p>
